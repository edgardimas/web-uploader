...
const addResultDetail = `INSERT INTO result_details 
                        (test_cd,test_nm,data_type,result_value,unit,flag,ref_range,status,test_comment,authorized_by,authorized_date,department,method,ono,result_ft) 
                        values 
...
const updateResultDetail = `UPDATE result_details
                            ...
                            authorized_date = $10, department = $11, method = $12, result_ft = $15
